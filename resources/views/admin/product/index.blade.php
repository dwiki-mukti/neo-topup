    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="{{ route('admin.product.create') }}" class="btn btn-primary btn-sm mr-1">Create New
                        Product</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="{{ asset('storage/' . $products->thumbnail) }}" class="rounded"
                                        style="max-width: 100px" alt="...">
                                    @else
                                    <div>
                                        <img src="{{ asset('assets/images/product/codm.png') }}" class="rounded"
                                            style="max-width: 100px" alt="...">
                                    </div>
                                    @endif
                                </td>
